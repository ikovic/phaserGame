...
const game = new Phaser.Game(800, 600, Phaser.AUTO, 'phaserWrapper', {
  preload: preload,
  create: create,
  update: update
});
...
function create() {
  ...
  sprintKey = game.input.keyboard.addKey(Phaser.KeyCode.SHIFT);
...
function update() {
  ...
  var sprintMultiplier = sprintKey.isDown ? 1.5 : 1;

  if (cursors.left.isDown) {
    //  Move to the left
    player.body.velocity.x = sprintMultiplier * -200;
